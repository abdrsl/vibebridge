...
async def handle_feishu_card_interaction(
    ...
    if event_type == "im.message.receive_v1":
        ...
        return await handle_im_message(event, background_tasks, header.get("app_id", ""))
...
async def handle_im_message(
    ...
    # 普通文本消息，使用原有的处理器
    return await handle_feishu_message(event, background_tasks, app_id)
...
async def handle_direct_card_action(
    body: Dict[str, Any],
    background_tasks: BackgroundTasks,
) -> Dict[str, Any]:
    """
